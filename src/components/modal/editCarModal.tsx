...
export default function EditCarModal({ isOpen, onClose, editCar, car }: EditCarModalProps) {
    ...
    const { register, handleSubmit, reset, formState: { errors, isValid } } = useForm<EditCarSchema>({
            ...
            <div className="w-full h-full inset-0 fixed flex justify-center items-center">
                <div className="w-[600px] h-fit bg-zinc-50 rounded-lg opacity-100 relative flex flex-col justify-center items-center">
                    <div className="w-full px-10 pt-10  flex justify-between">
                        ...
                        <button onClick={onClose}><IoClose className="size-6" /></button>
                    </div>
                    <form onSubmit={handleSubmit(handleEditCar)} className="w-full h-full p-10 flex flex-wrap gap-4">
                        <div className="flex-1 min-w-[250px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="brand" defaultValue={car.brand} {...register("brand")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[250px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="name" defaultValue={car?.name} {...register("name")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="color" defaultValue={car.color} {...register("color")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="number" id="year" defaultValue={car.year} {...register("year")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="number" id="price" defaultValue={car.price} {...register("price")} className="w-full border border-zinc-400 rounded py-2 px-4" />
