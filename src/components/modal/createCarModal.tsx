...
export default function CreateCarModal({ isOpen, onClose, createCar }: CreateCarModalProps) {
    const { register, handleSubmit, reset, formState: { errors } } = useForm<CreateCarSchema>({
        resolver: zodResolver(createCarSchema),
        mode: "onSubmit"
    })

    function handleCreateCar(data: CreateCarSchema) {
        const newCar = { ...data, id: uuidv4() }
        createCar(newCar);
        handleCloseModal()
    }
            ...
            <div className="w-full h-full inset-0 fixed flex justify-center items-center">
                <div className="w-[600px] h-fit bg-zinc-50 rounded-lg opacity-100 relative flex flex-col justify-center items-center">
                    <div className="w-full px-10 pt-10  flex justify-between">
                        ...
                        <button onClick={handleCloseModal} aria-label="Fechar modal"><IoClose className="size-6" /></button>
                    </div>
                    <form onSubmit={handleSubmit(handleCreateCar)} className="w-full h-full p-10 flex flex-wrap gap-4">
                        <div className="flex-1 min-w-[250px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="brand" data-testid="brand-input" {...register("brand")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[250px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="name" data-testid="name-input" {...register("name")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="text" id="color" data-testid="color-input" {...register("color")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="number" id="year" data-testid="year-input" {...register("year")} className="w-full border border-zinc-400 rounded py-2 px-4" />
                        ...
                        <div className="flex-1 min-w-[180px]">
                            <div className="w-full">
                                ...
                                <input type="number" id="price" data-testid="price-input" {...register("price")} className="w-full border border-zinc-400 rounded py-2 px-4" />
